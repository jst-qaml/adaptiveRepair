...
def overlay_radar_charts(dataset, kwargs):
    ...
    if 'input_dir_overlay' in kwargs:
        ...
        raise Exception("Require --input_dir_overlay")
    ...
    # Plot
    ax = _draw_each_radar_chart(input_dir,
                                fig,
                                min_lim,
                                max_lim,
                                legend,
                                'o-')
    _draw_each_radar_chart(input_dir_overlay,
                           fig,
                           min_lim,
                           max_lim,
                           legend_overlay,
    ...
    if input_dir_overlay2 is not None:
        _draw_each_radar_chart(input_dir_overlay2,
                               fig,
                               min_lim,
                               max_lim,
                               legend_overlay2,
...
def _draw_each_radar_chart(dir, fig, min_lim, max_lim, legend, plot):
    ...
    :return:
    """
    with open(dir.joinpath(r'results.json'), 'r') as f:
